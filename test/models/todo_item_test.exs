defmodule Redex.TodoItemTest do
  ...
  test "applying TodoItemAdded sets the name and todo list references", %{todo_item: todo_item} do
  ...
  test "applying TodoItemCompleted sets done to true", %{todo_item: todo_item} do
